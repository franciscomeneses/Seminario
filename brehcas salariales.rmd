...
```{r}
table_perob<- rbind(psych::describe(salarios19$salperobr),
               psych::describe(salarios09$salperobr),
               psych::describe(salarios99$salperobr))

rownames(table_perob) <- c( "2019","2009","1999")
...
```{r}
table_perger<- rbind(psych::describe(salarios19$salperger),
               psych::describe(salarios09$salperger),
               psych::describe(salarios99$salperger))

rownames(table_perger) <- c( "2019","2009","1999")
...
table_perob$year <- c(2019,2009,1999)

table_perger$ocup <- 2 # as.factor(c("Gerente"))
table_perger$year <- c(2019,2009,1999)
...
table_ed_gapper
 ...
 ggsave(table_ed_gapper,filename = "images/gapper_educ.png",device = "png",width = 30,height = 15,dpi = "retina",units = "cm")
...
table_ed_gapjus
 ...
 ggsave(table_ed_gapjus,filename = "images/gapjus_educ.png",device = "png",width = 30,height = 15,dpi = "retina",units = "cm")
```
