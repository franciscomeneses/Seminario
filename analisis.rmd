...
screenreg(list(results_1,results_2,results_3, results_4, results_5 ), type="text")
...
save(int1, file= "imagenes/int1.png")
save(int2, file= "imagenes/int2.png")
save(intcentrada, file= "imagenes/int3.png")
int1
int2
intcentrada
...
save(Correlaciones, file = "imagenes/correlaciones.html")  
...
save(regresion, file = "imagenes/reg.png")
