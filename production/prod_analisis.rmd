...
results_4 = lmer(p.civ ~ 1 + Libros +  Ocupacion + Educacion +  +  ip_padres  + m_nse + ip_estudiante  +  m_cult_part   + p.leng + (1 | idschool), data = data, REML=F)
...
texreg::knitreg(list(results_0,results_1, results_2,results_3, results_4, results_5), 
        ...
        custom.header = list("Modelos para explicar nivel de Conocimiento Civico" = 1:6),
